  ...
  describe "authorization" do
    describe "for non-signed-in users" do
      ...
      describe "in the Users controller" do
        ...
        describe "visigint the user index" do
      ...
      describe "when attempting to visit a protected page" do
        ...
        describe "after signing in" do
          ...
          describe "when signinig in again" do
            before do
              delete signout_path
              visit signin_path
              sign_in user
            ...
            it "should render the default (projile) page" do
    ...
    describe "singd in user action check" do
      let(:user) { FactoryGirl.create(:user) }
      before do
